...
class ConfiguradorInterativo:
    ...
    def _solicitar_valores(self, variaveis: List[str], existentes: Dict[str, str]) -> Dict[str, str]:
        """
    ...
    def configurar(self) -> bool:
        ...
        valores_obrigatorios = self._solicitar_valores(REQUIRED_VARS, valores_existentes)
        ...
        if configura_opcionais:
            ...
            valores_opcionais = self._solicitar_valores(OPTIONAL_VARS, valores_existentes)
        else:
            valores_opcionais = {var: valores_existentes.get(var, '') for var in OPTIONAL_VARS}
